...
<Callout type="info">
For static coupon rewards that are valid until stock lasts from the brand's end:
- `campaignCoverImage` will be optional
- `endDate` will be optional (these rewards remain live until stock lasts)
</Callout>
